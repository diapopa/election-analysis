...
total_votes = 0
# Create a candidate and county list
candidate_options =[]
county_options = []
# Create a candidate and county votes dictionary
candidate_votes = {}
county_votes = {}
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        county_name = row[1]
        # If the county name does not match any county name in the county optinons list
        if county_name not in county_options:
            # Add the county name to the county options list
            county_options.append(county_name)
            # Track county vote count
            county_votes[county_name] = 0
        # Add votes to corresponding county name
        ...
        # Add votes to corresponding candidate name
    ...
    with open(file_to_save, "w") as txt_file:
        ...
        for county in county_votes:
            # Retrieve total votes for each county
            votes = county_votes[county]
            # Calculate each county percentage of votes
            vote_percentage = float(votes)/float(total_votes) * 100
            # Print each county name, votes, and percentage of votes
            county_results = (
        ...
        # Set winning count and percentage to 0
        winning_count = 0
        winning_percentage = 0        
